...
/**
 * Servlet Filter implementation class FilNewuser
 */
@WebFilter("/ServNewuser")
public class FilNewuser implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if (curyear - biryear < 18) {
			pw.write("对不起，本站不接受18岁以下新用户");
			res.setHeader("Refresh", "2;URL=inputnewuser.jsp");
			return;
		}
		try {
